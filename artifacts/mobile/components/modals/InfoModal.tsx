...
export function InfoModal() {
  ...
  const content: Record<Tab, { title: string; body: string }> = {
    ...
    cara: {
      ...
      body: isIndo
        ? '1. Tekan tombol "Jatuhkan" untuk menjatuhkan bola ke papan.\n\n2. Bola akan memantul ke paku dan mendarat di kotak poin.\n\n3. Setiap kotak memiliki nilai POIN berbeda (5x–150x). Kotak ADS memberi bonus, ZONK tidak memberi poin.\n\n4. Gunakan POIN untuk ditukar ke Rupiah di menu Penarikan.\n\n5. Kurs Penarikan: 1.000 POIN = Rp10\n\n6. Kumpulkan POIN sebanyak mungkin dan tarik ke akun DANA kamu!\n\n7. Tonton iklan untuk mendapatkan bola tambahan gratis.\n\n8. Bonus Harian dan Roda Keberuntungan tersedia setiap hari.'
        : '1. Press "Drop Ball" to drop a ball onto the board.\n\n2. The ball bounces off pegs and lands in a bucket.\n\n3. Each bucket has a POINT value (5x–150x). ADS = bonus, ZONK = no points.\n\n4. Use POINTS to exchange for Rupiah in the Withdraw menu.\n\n5. Exchange Rate: 1,000 POINTS = Rp10\n\n6. Collect as many POINTS as possible and withdraw to your DANA account!\n\n7. Watch ads to get free extra balls.\n\n8. Daily Bonus and Spin Wheel available every day.',
    },
    disclaimer: {
      title: 'Disclaimer',
      body: isIndo
